    ...
    <div class="page-container">
                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                                <a href="invoice.html"><i class="fa fa-briefcase"></i> <span>Lowongan Magang</span></a>
                            </li>
                            <li>
                                <a href="invoice.html"><i class="fa fa-users"></i> <span>Siswa</span></a>
                            </li>
                            <li>
                                <a href="invoice.html"><i class="fa fa-industry"></i> <span>Industri</span></a>
                            </li>
                            <li>
                                <a href="invoice.html"><i class="fa fa-calendar"></i> <span>Workshop & Event</span></a>
                            </li>
                            <li>
                                <a href="invoice.html"><i class="fa fa-pencil"></i> <span>Artikel</span></a>
                            </li>
                            <li>
                                <a href="invoice.html"><i class="fa fa-lock"></i> <span>Admin</span></a>
                            </li>
                            <li>
                                <a href="invoice.html"><i class="fa fa-money"></i> <span>Pembayaran</span></a>
                            </li>
                        </ul>
                    </nav>
                </div>
        ...
        <div class="main-content">
                        ...
                        <ul class="notification-area pull-right">
                            ...
                            <li class="dropdown">
                                ...
                                <div class="dropdown-menu bell-notify-box notify-box">
                                    <span class="notify-title">You have <?= $countnot ?> new notifications <a href="#">view all</a></span>
                                    <div class="nofity-list">
                                        <?php foreach ($notif as $n) {?>
                                            <a href="<?= base_url('notif/detail/'.$n->id) ?>" class="notify-item">
                                                <div class="notify-thumb"><i class="fas fa-comment-alt-exclamation btn-warning"></i></div>
                                                <div class="notify-text">
                                                    <p><?= substr($n->isinot,0,80) ?>...</p>
                                                    <span>
                                                    <?php
                                                        $awal = $n->waktu;
                                                        $date = new DateTime($awal);   
                                                        $now = new DateTime();
                                                        echo $date->diff($now)->format("%a days ago");
                                                    ?>
                                                    </span>
                                                </div>
                                            </a>
            ...
            <div class="col-md-12 mt-3">
                <div class="card">
                    <div class="card-body">
                        <?php foreach ($notifall as $n) {?>
                            <?php if ($n->status == 0) {?>
                                <div class="nofity-list bg-secondary">
                                <a href="<?= base_url('notif/detail/'.$n->id) ?>" class="notify-item text-white">
                                <div class="notify-thumb"><i class="fas fa-comment-alt-exclamation btn-warning"></i></div>
                                    <div class="notify-text">
                                        <p><?= substr($n->isinot,0,80) ?>...</p>
                                        <span>
                                ...
                                <?php } else { ?>
                            <div class="nofity-list btn-light">
                            <a href="<?= base_url('notif/detail/'.$n->id) ?>" class="notify-item">
                            <div class="notify-thumb"><i class="fas fa-comment-alt-exclamation btn-warning"></i></div>
                                <div class="notify-text">
                                    <p><?= substr($n->isinot,0,80) ?>...</p>
